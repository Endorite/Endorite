...
public class GameActivity extends SimpleBaseGameActivity implements IOnSceneTouchListener, RoomRequestListener, NotifyListener {
	...
	protected void onCreateResources() {
		...
		this.mBitmapTextureAtlas1 = new BitmapTextureAtlas(this.getTextureManager(), 60, 60);
		this.mBitmapTextureAtlas2 = new BitmapTextureAtlas(this.getTextureManager(), 60, 60);
		this.mBitmapTextureAtlas3 = new BitmapTextureAtlas(this.getTextureManager(), 60, 60);
		this.mBitmapTextureAtlas4 = new BitmapTextureAtlas(this.getTextureManager(), 60, 60);
		
		this.fruitBitmapTextureAtlas1 = new BitmapTextureAtlas(this.getTextureManager(), 100, 100);
		this.fruitBitmapTextureAtlas2 = new BitmapTextureAtlas(this.getTextureManager(), 100, 100);
		this.fruitBitmapTextureAtlas3 = new BitmapTextureAtlas(this.getTextureManager(), 100, 100);
		this.fruitBitmapTextureAtlas4 = new BitmapTextureAtlas(this.getTextureManager(), 100, 100);
		
		this.coinBitmapTextureAtlas = new BitmapTextureAtlas(this.getTextureManager(), 68, 64);
